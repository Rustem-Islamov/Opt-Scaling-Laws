...
def generate_grid_configs(reference_config:str, budget: int, lrs: list[float], batch_sizes: list[int], seq_length:int):
    ...
    for batch_size in batch_sizes:
        for lr in lrs:
            ...
            hyperparameters.run = f"scion_lr{lr}_bs{batch_size}_it{int(num_iters)}"
...
if __name__ == "__main__":
    reference_config = "/iopsstor/scratch/cscs/rmachace/scion-experimental/examples/modded-nanogpt/configs/scion.yaml"
    seq_length = 1024
