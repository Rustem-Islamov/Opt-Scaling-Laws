...
import os
os.environ.setdefault("TORCHINDUCTOR_CACHE_DIR", "/home/eduard.gorbunov/Rustem_Islamov/scion/.inductor_cache")
os.environ.setdefault("TRITON_CACHE_DIR", "/home/eduard.gorbunov/Rustem_Islamov/scion/.triton_cache")
...
from optimizers.opt_scion import OptimisticScion
...
optimizer1 = OptimisticScion(optim_groups, lr=args.lr_embed, 
