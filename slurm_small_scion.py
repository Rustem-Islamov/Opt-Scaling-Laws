...
#SBATCH --mem=160G
#SBATCH -o scion_train_logs/%x_%A.out
#SBATCH -e scion_train_logs/%x_%A.err
...
base_lr = 3.6e-4
cfg["batch_size"] = 380
cfg["device_batch_size"] = 5
cfg["lr_embed"] = base_lr
cfg["lr_matrix"] = base_lr
cfg["sequence_length"] = 1475
cfg["val_loss_every"] = 1000
cfg["n_layer"] = 24
cfg["n_head"] = 10
cfg["n_embd"] = 1280
t_budget = 9850*380*1475
cfg["val_tokens"] = 10649500
cfg["num_iterations"] = int(t_budget/cfg["sequence_length"]/cfg["batch_size"])

cfg["project"] += f"LR-check-budget-{t_budget}"
