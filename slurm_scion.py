...
cfg["num_iterations"] = int(2550*512/cfg["batch_size"])

#cfg["project"] = f"124M-Val-Loss-1024-correct-seqlen-budget{t_budget}"
#cfg["project"] = f"124M-Val-Loss-1024-correct-batch-budget{t_budget}"
cfg["project"] = f"124M-Val-Loss-1024-correct-tune-alpha-budget{t_budget}"
cfg["warmdown_iters"] = int(0.28*cfg["num_iterations"])


run = cfg.get("run", "scion")
cfg["run"] = f"{run}_{cfg['batch_size']}_{cfg['num_iterations']}_{alpha}"
